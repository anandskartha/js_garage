    ...
    return (
        <div className="card container-border">
            ...
            <div className="container">
                ...
                <p>Javascript full stack developer with an experience of over 9 years in the industry</p>
                <p>Please contact me by filling out the form below, or through Email or Linkedin.</p>
